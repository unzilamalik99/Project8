  ...
  return (
    <div className="relative flex flex-col-reverse">
      <div className="flex items-center justify-center flex flex-col ">
        ...
        <p className="text-yellow-600 text-left text-balance">{currentVideo.country}</p>
            <h3 className="text-3xl font-bold font-large text-left text-yellow-800 mb-2 text-balance">{currentVideo.$}</h3>
            </div>
      </div>
    </div>
  );
